...
function Landing() {
  return(
    <div className="flex text-center">
      <div className="lg:w-[60%] w-[50%] bg-yellow-300 h-screen">
        <div className="lg:m-[25%] md:mt-[60%]">
        <h1 className="text-3xl my-6 mt-12 lg:text-7xl md:text-5xl">¡Bienvenido!</h1>
      ...
      <div className="lg:w-[40%] w-[50%] bg-black h-screen">
