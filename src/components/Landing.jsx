...
function Landing() {
  return (
    <div className="flex flex-col md:flex-row text-center">
      <div className="w-full md:w-[50%] bg-yellow-300 h-[50vh] md:h-screen">
        <div className="lg:m-[25%] md:mt-[60%]">
          <h1 className="text-3xl my-6 mt-12 lg:text-7xl md:text-5xl">
            ¡Bienvenido!
          </h1>
          <p className="m-4 text-lg">
            Entra a la mejor comunidad de Henry's en el mundo, donde puedes ver
            otros Henry en tu zona, chatear e intercambiar ideas, historias,
            proyectos y compartir muchas sonrisas y buena vibra.
          </p>
          <Link to="/inicio">
      ...
      <div className="lg:w-[50%] w-full md:w-[50%] bg-black h-fit md:h-screen">
        <div className="grid grid-cols-2 gap-1 m-4 mt-14 lg:grid-cols-4 md:grid-cols-3 md:gap-2 lg:mt-36 md:mt-8">
          <img
